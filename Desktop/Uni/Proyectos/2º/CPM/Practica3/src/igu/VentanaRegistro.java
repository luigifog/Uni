...
public class VentanaRegistro extends JFrame {
	...
	{
		String password = txtContra.getPassword().toString();
        String password2 = txtContra2.getPassword().toString();
		...
		if (btSiguiente == null) {
			...
			btSiguiente.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					{problema=problema+ " contraseña " ;}
					if(String.valueOf(txtContra2.getPassword()).length()<=0)
					{problema=problema+ " contraseña2 " ;}
