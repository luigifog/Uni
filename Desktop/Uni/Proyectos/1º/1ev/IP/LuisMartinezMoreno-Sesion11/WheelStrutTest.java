...
public class WheelStrutTest
{
   ...
   public void testConstructorWithParam()
   {
       ...
       WheelStrut wheelStrut2= new WheelStrut(1);
       assertTrue(wheelStrut2.getDeployed());
       assertEquals(1, wheelStrut2.size());
       Wheel wheel2;
       for (int i=1; i<wheelStrut1.size(); i++)
       {
           wheel2=wheelStrut2.getWheel(i);
           assertEquals(WheelStrut.NORMAL_PRESSURE,wheel2.getPressure());
           assertEquals(WheelStrut.NORMAL_PRESSURE,wheel2.getMaxPressure());
       }
       //caso5 creo puntal con 20 ruedas
       WheelStrut wheelStrut3= new WheelStrut(20);
       assertTrue(wheelStrut3.getDeployed());
       assertEquals(20, wheelStrut3.size());
       Wheel wheel3;
       for (int i=0; i<wheelStrut1.size(); i++)
       {
           wheel3=wheelStrut3.getWheel(i);
           assertEquals(WheelStrut.NORMAL_PRESSURE,wheel3.getPressure());
           assertEquals(WheelStrut.NORMAL_PRESSURE,wheel3.getMaxPressure());
       }
   }
}
