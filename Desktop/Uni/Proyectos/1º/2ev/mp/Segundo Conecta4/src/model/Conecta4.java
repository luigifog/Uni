...
public class Conecta4 {
	...
	public boolean dpSum(int f, int c)
	{
	...
	public boolean dpAst(int f, int c)
	{
		int contF=f;int contC=c;
		int cont=0;
		do
	...
	public boolean dnSum(int f,int c)
	{
		int contF=f;int contC=c;
		int cont=0;
		do
	...
	public boolean dnAst(int f,int c)
	{
		int contF=f;int contC=c;
		int cont=0;
		do
	...
	public void rellenarAst(int row, int col)
	{
		tablero[row][col]=AST;
	}
	
	public void rellenarSum(int row, int col)
	{
		tablero[row][col]=SUM;
	}
}
