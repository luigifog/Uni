...
//
//		webServer.addFile(new Image("Logo.png", "http://www.mp.org/content/logo.png", 120,"Web Site Logo",ImageFormat.PNG));
//		webServer.addFile(new Video("Intro.avi", "http://www.mp.org/content/intro.avi", 20048,"Presentation",VideoFormat.AVI));
//		webServer.addFile(new Audio("Sound.mp3", "http://www.mp.org/content/sound.mp3", 10256,"Soundtrack",AudioFormat.MP3));
//		
...
//		webServer.listPlayableFiles(System.out);
//		System.out.println("");
//		
